<!-- Start::app-content -->
<div class="main-content app-content" id="app-wrapper" menu-active-path="sirup">
            ...
            <div class="col-xl-5">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="row mb-4">
                                <label for="inputEmail3" class="col-sm-3 col-form-label"><b>Tahun</b></label>
                                <div class="col-sm-9">
                                    <select id="paket-name" class="form-control" v-model="form.tahun">
                                        <option v-for="year in dataYear" :key="year" :value="year">{{ year }}</option>
                                    </select>
                                </div>
                            </div>

                            <div class="row mb-4">
                                <label for="inputEmail3" class="col-sm-3 col-form-label"><b>Report</b></label>
                                <div class="col-sm-9">
                                    <select id="paket-name" class="form-control" v-model="form.report">
