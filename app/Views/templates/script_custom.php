...
<!-- Datatables Cdn -->
<script src="<?= base_url() ?>assets/js/libs/jquery.dataTables.min.js"></script>
<script src="<?= base_url() ?>assets/js/libs/dataTables.bootstrap5.min.js"></script>
<script src="<?= base_url() ?>assets/js/libs/dataTables.responsive.min.js"></script>
<script src="<?= base_url() ?>assets/js/libs/dataTables.buttons.min.js"></script>
<script src="<?= base_url() ?>assets/js/libs/buttons.print.min.js"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.6/pdfmake.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js"></script> -->
<script src="<?= base_url() ?>assets/js/libs/buttons.html5.min.js"></script>
<script src="<?= base_url() ?>assets/js/libs/jszip.min.js"></script>
